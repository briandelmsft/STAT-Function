...
def execute_aadrisks_module (req_body):
    ...
    if req_body.get('AddIncidentTask', True) and aadrisks_object.FailedMFATotalCount > 0 or aadrisks_object.MFAFraudTotalCount > 0 or aadrisks_object.SuspiciousActivityReportTotalCount > 0 or ( aadrisks_object.HighestRiskLevel != 'None' and aadrisks_object.HighestRiskLevel != 'Unknown'):
