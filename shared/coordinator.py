from modules import base, kql, watchlist, ti, relatedalerts, scoring, ueba, playbook, exchange, aadrisks, aadinsights, file, createincident, mdca, mde, exposure_device, exposure_user
...
def initiate_module(module_name, req_body):
    ...
    match module_name:
        ...
        case 'aadinsights':
            return_data = aadinsights.execute_aadinsights_module(req_body)
        case 'deviceexposure':
