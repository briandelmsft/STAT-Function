from modules import base, kql, watchlist, ti, relatedalerts, scoring, ueba, playbook, oof, aadrisks, file, createincident, mdca, mde, copilot
...
def initiate_module(module_name, req_body):
    ...
    match module_name:
        ...
        case 'copilot':
            return_data = copilot.execute_copilot_module(req_body)
        case _:
